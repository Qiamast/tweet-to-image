    ...
    if(hint){
    	return (
    		<Box m="0 auto" className='non-tweet i' py='2rem' flexDirection='column'>
    		    ...
    		    <Text className='i' p='4' color='gray.700' textAlign='center'>سلام خیلی خوش آمدید . برای  تبدیل توییت به پست اینستاگرام لطفا آدرس توییت را در قسمت بالا پیست کنید</Text>
    		</Box>
    	)
    }
